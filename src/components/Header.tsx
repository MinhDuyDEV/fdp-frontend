...
export default function Header({ activeGenre = 'all', onGenreChange, showGenreNav = true }: Props) {
          ...
          {(['all', ...GENRES] as (Genre | 'all')[]).map((g) => (
            <button
              ...
              style={{
                ...
                borderBottom: activeGenre === g ? '2px solid var(--ink)' : '2px solid transparent',
